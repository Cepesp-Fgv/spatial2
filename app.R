  ...
  navbarPage(
    ...
    tabPanel("Mapa",div(class="outer",
      ...
      margin-right: 10px; margin-top: 250px;
                 ...
                 tabPanel("Gráficos",
                          fluidRow(column(width=3,""),column(width=4,plotOutput("QL_dist")),
                                   column(width=4,plotOutput("G_cand", height="200px"),
                                          plotOutput("I_cand", height="200px"))),
                          bootstrapPage(absolutePanel(id = "cuts", class = "panel panel-default", fixed = TRUE,
                                                      draggable = TRUE, top = "auto", left = "auto", right = 30, bottom = 5,
                 ...
                 tabPanel("Clusters",
                          ...
                          column(width=1,""),
                          column(width=3,leafletOutput("map_clusters",width="500px",height="400px"))
                 ),
                 tabPanel("Extremos",
                          column(width=3,""),
                          column(width=4,h4("Top and Bottom 5 G Index in this State and Year"),dataTableOutput("Extremes")),
                          column(width=1,""),
                          column(width=3,leafletOutput("map_selected_hi",width="500px",height="400px"))
                 ),
                 tabPanel("Sobre",
                          column(width=3,""),
